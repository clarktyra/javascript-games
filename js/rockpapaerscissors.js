...
function printComChoice(){
    ...
    if(computerChoice === "rock"){
     document.getElementById("choiceArea").innerHTML = `<img  src="images/5a35c7b6db90f5.0034759615134739748994.png"/>`
    } else if(computerChoice === "paper"){
        document.getElementById("choiceArea").innerHTML = `<img  src="images/kisspng-post-it-note-paper-clip-art-post-it-note-png-5ab44be02d5f60.7688322515217653441859.png"/>`
    } else if(computerChoice === "scissors"){
        document.getElementById("choiceArea").innerHTML = `<img  src="images/kisspng-scissors-clip-art-scissors-5a80f8a6d8be97.1303518815184017028878.png"/>`
    }
    winner();
}
